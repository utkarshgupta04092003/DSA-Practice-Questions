...
public class Solution {
	...
	private static void diameterOfBinaryTree(BinaryTreeNode<Integer>root, int maxi[]){
		...
		maxi[0] = Math.max(maxi[0],1+leftHeight+rightHeight);
...
public class Solution {
	...
	private static int diameterOfBinaryTree(BinaryTreeNode<Integer>root,int maxi[]){
		if(root == null)
			return 0;

		int leftHeight = diameterOfBinaryTree(root.left,maxi);
		int rightHeight = diameterOfBinaryTree(root.right,maxi);

		maxi[0] = Math.max(maxi[0],leftHeight+rightHeight+1);
	...
	public static int diameterOfBinaryTree(BinaryTreeNode<Integer> root){
		...
		int maxi[] = new int[1];
		int ans = diameterOfBinaryTree(root,maxi);
